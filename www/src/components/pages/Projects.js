	...
	function createSubmit(record) {
		...
		return new Promise((resolve, reject) => {
			...
			body.create('admin', 'project', { record }).then(data => {
				...
				// Notify the user
				events.get('success').trigger('Project created. Refreshing project list.');
	...
	function resultRemove(key) {
		...
		body.delete('admin', 'project', { _id: key }).then(data => {
			if(data) {
				...
				// Notify the user
				events.get('success').trigger('Project deleted. Refreshing project list.');
	...
	function updateSubmit(record, key) {
		...
		return new Promise((resolve, reject) => {
			...
			body.update('admin', 'project', {
				...
				// Notify the user
				events.get('success').trigger('Project updated. Refreshing project list.');
